...
lyr_FASILITAS_KESEHATAN_3.set('fieldAliases', {'Long': 'Long', 'Lat': 'Lat', 'Nama': 'Nama', 'Ket': 'Ket', 'Buka_24_JA': 'Buka_24_JA', 'PARKIR': 'PARKIR', 'Alamat': 'Alamat', 'Kecamatan': 'Kecamatan', 'Kota': 'Kota', 'Provinsi': 'Provinsi', });
...
lyr_FASILITAS_KESEHATAN_3.set('fieldImages', {'Long': 'TextEdit', 'Lat': 'TextEdit', 'Nama': 'TextEdit', 'Ket': 'TextEdit', 'Buka_24_JA': 'TextEdit', 'PARKIR': 'TextEdit', 'Alamat': 'TextEdit', 'Kecamatan': 'TextEdit', 'Kota': 'TextEdit', 'Provinsi': 'TextEdit', });
...
lyr_FASILITAS_KESEHATAN_3.set('fieldLabels', {'Long': 'inline label - visible with data', 'Lat': 'inline label - visible with data', 'Nama': 'inline label - visible with data', 'Ket': 'inline label - visible with data', 'Buka_24_JA': 'inline label - visible with data', 'PARKIR': 'inline label - visible with data', 'Alamat': 'inline label - visible with data', 'Kecamatan': 'inline label - visible with data', 'Kota': 'inline label - visible with data', 'Provinsi': 'inline label - visible with data', });
